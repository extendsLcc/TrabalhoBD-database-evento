...
/*  Atividade   20 */
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor`, `data`,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (1,  10.0,  '2018-09-19'," Fundamentos de Gerenciamento de Projetos","dapibus rutrum, justo. Praesent luctus. Curabitur egestas nunc sed libero.", 21,3,2,39,1, 1 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor`, `data`,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (2,  20.0,  '2018-09-18'," Utilização de óleo vegetal residual como incentivo a educação ambiental","nec ante. Maecenas mi felis, adipiscing fringilla, porttitor vulputate, posuere", 25,1,1,37,7, 2 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor`, `data`,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (3,  30.0,  '2018-08-17'," Arte e saúde mental: vivenciando a cor a partir da aquarela","blandit viverra. Donec tempus, lorem fringilla ornare placerat, orci lacus", 27,2,2,37,2, 3 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor`, `data`,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (4,  40.0,  '2018-09-16'," Técnicas em aquarela para iniciantes","leo. Vivamus nibh dolor, nonummy ac, feugiat non, lobortis quis,", 26,2,1,33,8, 4 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor`, `data`,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (5,  50.0,  '2018-08-15'," Introdução às planilhas eletrônicas","enim, gravida sit amet, dapibus id, blandit at, nisi. Cum", 21,3,2,34,6, 1 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor`, `data`,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (6,  60.0,  '2018-09-14'," O que corre em suas veias? Introdução ao estudo de células sanguíneas","Proin sed turpis nec mauris blandit mattis. Cras eget nisi", 39,3,2,33,1, 2 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor`, `data`,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (7,  70.0,  '2018-09-13'," Photoshop","ultrices sit amet, risus. Donec nibh enim, gravida sit amet,", 34,3,2,34,1, 3 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor`, `data`,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (8,  80.0,  '2018-08-12'," Robótica no desenvolvimento da lógica de programação","erat volutpat. Nulla dignissim. Maecenas ornare egestas ligula. Nullam feugiat",22,2,2,36,4, 4 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor`, `data`,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (9,  90.0,  '2018-09-00'," Noção básica de programação de Jogos 2D no Construct 2","luctus et ultrices posuere cubilia Curae; Phasellus ornare. Fusce mollis.",39,1,1,31,2, 1 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor`, `data`,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (10, 100.0, '2018-09-01',"A Tecnologia Blockchain do Zero: Aplicações e Impactos","ut, molestie in, tempus eu, ligula. Aenean euismod mauris eu",26,3,2,31,5, 2 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor`, `data`,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (11, 110.0, '2018-09-02',"Arquitetura contemporânea e o mundo do trabalho","ac tellus. Suspendisse sed dolor. Fusce mi lorem, vehicula et,",31,2,2,33,6, 3 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor`, `data`,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (12, 120.0, '2018-09-03',"Relatórios com JasperReports e iReport Designer","ornare, libero at auctor ullamcorper, nisl arcu iaculis enim, sit",32,2,1,37,8, 4 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor`, `data`,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (13, 130.0, '2018-09-04',"Utilização de óleo vegetal  residual como incentivo a educação ambiental","molestie orci tincidunt adipiscing. Mauris molestie pharetra nibh. Aliquam ornare,",31,3,1,34,2, 1 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor`, `data`,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (14, 140.0, '2018-09-05',"Lei das Águas","Morbi quis urna. Nunc quis arcu vel quam dignissim pharetra.",30,1,2,37,8, 2 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor`, `data`,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (15, 150.0, '2018-09-06',"O aprendizado da Libras por meio da música","ornare egestas ligula. Nullam feugiat placerat velit. Quisque varius. Nam",32,3,1,35,8, 3 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor`, `data`,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (16, 160.0, '2018-09-07',"Introdução à planilhas eletrônicas","lacinia mattis. Integer eu lacus. Quisque imperdiet, erat nonummy ultricies",40,3,2,34,2, 4 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor`, `data`,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (17, 170.0, '2018-09-08',"Arte e saúde mental: vivenciando a cor a partir da aquarela","Mauris quis turpis vitae purus gravida sagittis. Duis gravida. Praesent",23,1,1,36,5, 1 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor`, `data`,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (18, 180.0, '2018-08-09',"Produção de mudas","habitant morbi tristique senectus et netus et malesuada fames ac",27,3,1,40,8, 2 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor`, `data`,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (19, 190.0, '2018-09-10',"Cenários Econômicos","sed pede nec ante blandit viverra. Donec tempus, lorem fringilla",31,3,2,39,1, 3 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor`, `data`,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (20, 200.0, '2018-09-11',"Como elaborar um currículo?","erat. Vivamus nisi. Mauris nulla. Integer urna. Vivamus molestie dapibus",34,3,1,37,8, 4 );

/*  Inscrição   */
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (1,"2018-11-07",1,2);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (2,"2018-11-07",2,1);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (3,"2018-11-10",3,1);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (4,"2018-11-11",4,2);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (5,"2018-11-07",5,2);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (6,"2018-11-11",6,2);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (7,"2018-11-08",7,1);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (8,"2018-11-14",8,1);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (9,"2018-11-10",9,2);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (10,"2018-11-07",10,1);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (11,"2018-11-11",11,2);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (12,"2018-11-07",12,1);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (13,"2018-11-08",10,2);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (14,"2018-11-08",14,1);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (15,"2018-11-10",15,1);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (16,"2018-11-10",16,2);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (17,"2018-11-07",17,1);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (18,"2018-11-13",18,2);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (19,"2018-11-08",19,2);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (20,"2018-11-13",20,1);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (21,"2018-11-07",21,2);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (22,"2018-11-08",22,2);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (23,"2018-11-07",23,1);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (24,"2018-11-08",24,1);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (25,"2018-11-11",25,1);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (26,"2018-11-14",26,2);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (27,"2018-11-14",27,2);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (28,"2018-11-13",28,1);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (29,"2018-11-10",29,1);
INSERT INTO `eventos`.`inscricao` (`idInscricao`,`dataInscricao`,`Participante_Pessoa_idPessoa`,`Evento_idEvento`) VALUES (30,"2018-11-07",30,2);
...
INSERT INTO `eventos`.`inscricaoatividade` (`idInscricaoAtividade`,`Atividade_idAtividade`,`Inscricao_idInscricao`,`dataPagamento`) VALUES (5,1,4,NULL);
INSERT INTO `eventos`.`inscricaoatividade` (`idInscricaoAtividade`,`Atividade_idAtividade`,`Inscricao_idInscricao`,`dataPagamento`) VALUES (6,1,5,"1969-12-31");
...
INSERT INTO `eventos`.`inscricaoatividade` (`idInscricaoAtividade`,`Atividade_idAtividade`,`Inscricao_idInscricao`,`dataPagamento`) VALUES (8,1,7,"1969-12-31");
...
INSERT INTO `eventos`.`inscricaoatividade` (`idInscricaoAtividade`,`Atividade_idAtividade`,`Inscricao_idInscricao`,`dataPagamento`) VALUES (20,1,19,"1969-12-31");
