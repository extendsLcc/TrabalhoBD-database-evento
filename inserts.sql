...
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor` ,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (4,  40.0," Técnicas em aquarela para iniciantes","leo. Vivamus nibh dolor, nonummy ac, feugiat non, lobortis quis,", 26,2,1,33,8, 4 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor` ,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (5,  50.0," Introdução às planilhas eletrônicas","enim, gravida sit amet, dapibus id, blandit at, nisi. Cum", 21,3,2,34,6, 1 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor` ,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (6,  60.0," O que corre em suas veias? Introdução ao estudo de células sanguíneas","Proin sed turpis nec mauris blandit mattis. Cras eget nisi", 39,3,2,33,1, 2 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor` ,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (7,  70.0," Photoshop","ultrices sit amet, risus. Donec nibh enim, gravida sit amet,", 34,3,2,34,1, 3 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor` ,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (8,  80.0," Robótica no desenvolvimento da lógica de programação","erat volutpat. Nulla dignissim. Maecenas ornare egestas ligula. Nullam feugiat",22,2,2,36,4, 4 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor` ,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (9,  90.0," Noção básica de programação de Jogos 2D no Construct 2","luctus et ultrices posuere cubilia Curae; Phasellus ornare. Fusce mollis.",39,1,1,31,2, 1 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor` ,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (10, 100.0, "A Tecnologia Blockchain do Zero: Aplicações e Impactos","ut, molestie in, tempus eu, ligula. Aenean euismod mauris eu",26,3,2,31,5, 2 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor` ,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (11, 110.0, "Arquitetura contemporânea e o mundo do trabalho","ac tellus. Suspendisse sed dolor. Fusce mi lorem, vehicula et,",31,2,2,33,6, 3 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor` ,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (12, 120.0, "Relatórios com JasperReports e iReport Designer","ornare, libero at auctor ullamcorper, nisl arcu iaculis enim, sit",32,2,1,37,8, 4 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor` ,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (13, 130.0, "Utilização de óleo vegetal  residual como incentivo a educação ambiental","molestie orci tincidunt adipiscing. Mauris molestie pharetra nibh. Aliquam ornare,",31,3,1,34,2, 1 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor` ,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (14, 140.0, "Lei das Águas","Morbi quis urna. Nunc quis arcu vel quam dignissim pharetra.",30,1,2,37,8, 2 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor` ,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (15, 150.0, "O aprendizado da Libras por meio da música","ornare egestas ligula. Nullam feugiat placerat velit. Quisque varius. Nam",32,3,1,35,8, 3 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor` ,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (16, 160.0, "Introdução à planilhas eletrônicas","lacinia mattis. Integer eu lacus. Quisque imperdiet, erat nonummy ultricies",40,3,2,34,2, 4 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor` ,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (17, 170.0, "Arte e saúde mental: vivenciando a cor a partir da aquarela","Mauris quis turpis vitae purus gravida sagittis. Duis gravida. Praesent",23,1,1,36,5, 1 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor` ,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (18, 180.0, "Produção de mudas","habitant morbi tristique senectus et netus et malesuada fames ac",27,3,1,40,8, 2 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor` ,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (19, 190.0, "Cenários Econômicos","sed pede nec ante blandit viverra. Donec tempus, lorem fringilla",31,3,2,39,1, 3 );
INSERT INTO `eventos`.`atividade` (`idAtividade`,`valor` ,`titulo`,`descricao`,`limiteInscricoes`,`TipoAtividade_idTipoAtividade`,`Evento_idEvento`,`Palestrante_Pessoa_idPessoa`,`Sala_idSala`, `CargaHoraria_idCargaHoraria`) VALUES (20, 200.0, "Como elaborar um currículo?","erat. Vivamus nisi. Mauris nulla. Integer urna. Vivamus molestie dapibus",34,3,1,37,8, 4 );
